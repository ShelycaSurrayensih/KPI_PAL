    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Tupoksi Departemen</h4>
                    ...
                    <div class="table-responsive table-card mt-3 mb-1">
                        <table class="table align-middle table-nowrap" id="timTable">
                            ...
                            <tbody class="list form-check-all">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="edit">
                                                <button class="btn btn-sm btn-success edit-item-btn"
                                                    ...
                                                    data-bs-target="#showModal{{ $departemen->id_departemen }}">Edit</button>
                                            </div>
                                            <div class="remove">

                                                <form action="{{ route('tupoksiDepartemen.destroy', $departemen->id_departemen) }}"
                                                    method="POST">
                                ...
                                <!-- edit Modal -->
                                <div class="modal fade" id="showModal{{ $departemen->id_departemen }}" tabindex=" -1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post"
                                                    action="{{ route('tupoksiDepartemen.update', $departemen->id_departemen) }}"
...
<div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('KPI_TupoksiDepartemen.store') }}" enctype="multipart/form-data"
                    id="myForm">
                    @csrf
