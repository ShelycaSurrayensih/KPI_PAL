                                    ...
                                    @for($prok_count=1 ; $prok_count <= 4 ; $prok_count++) <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal" data-bs-target="#showModal{{$prok->id}}">Edit</button>
                                                    </div>
                                                    <div class="remove">
                                        ...
                                        <!-- edit Modal -->
                                        <div class="modal fade" id="showModal{{$prok->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-light p-3">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" action="{{route('cascadeProker.update', $prok->id)}}" enctype="multipart/form-data" id="myForm">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="tw" class="form-label">TW</label>
                                                                <input name="tw" type="text" class="form-control" id="cas_kpiName" value="{{$prok->tw}}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="progress" class="form-label">Progress</label>
                                                            ...
                                                            <div class="modal-footer">
                                                                <div class="hstack gap-2 justify-content-end">
                                                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                                                                    <button type="submit" class="btn btn-success" id="edit-btn">Update Proker Cascade</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
