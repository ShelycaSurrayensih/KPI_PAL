                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarDashboards">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="dashboard-nft.html" class="nav-link"> <span data-key="t-nft">NFT</span>
                                ...
                                <ul class="nav nav-sm flex-column">
                                            ...
                                            <ul class="nav nav-sm flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#sidebaremailTemplates" class="nav-link"
                                                        ...
                                                        <span data-key="t-email-templates">Email Templates</span> <span
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarnft" class="nav-link" data-bs-toggle="collapse" role="button"
                                            ...
                                            <span data-key="t-nft-marketplace">NFT Marketplace</span> <span
                                                class="badge badge-pill bg-danger" data-key="t-new">New</span>
                                        </a>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarForms">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="forms-select2.html" class="nav-link"><span
                                                data-key="t-select2">Select2</span> <span
